...
\begin{frame}
  ...
  \medskip
Az érintési portfólió az a portfólió, ami a legmagasabb Sharpe-rátával, ebből kiindulva ezt a koncepciót \textcite{pedersen_responsible_2021} általánosította azzal, hogy \alert{minden egyes sztenderizált proxy mellett} (jelen esteben biodiversity score), \alert{meghatározható a maximálisan elérhető Sharpe-ráta}.\\
  \bigskip
