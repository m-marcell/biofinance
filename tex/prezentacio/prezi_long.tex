...
\begin{frame}
  ...
  \end{block}
  A random generált portfólió \alert{eszközeinek számossága mindig meg kell egyeznie} a BIODIV-SR adott pontjaihoz tartozó portfólió számosságával.
\end{frame}

\begin{frame}
  \frametitle{Kutatási kérdések}
  \begin{enumerate}
    \item A biodiverzitási preferenciával rendelkező befektetők az egész univerzumból választanak (long vagy short pozíció egyaránt), nem pedig egyszerű kizárási stratégiát alkalmaznak.\footcite{pedersen_responsible_2021} 
